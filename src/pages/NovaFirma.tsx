  ...
  return (
    <div className="flex flex-col h-full bg-[#F5F7FA] dark:bg-slate-950">
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar flex flex-col text-slate-800 dark:text-slate-200">
                ...
                <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                       ...
                       <div className="space-y-1.5">
                          ...
                          <input required={!isInformal} type="text" value={nif} onChange={e => setNif(e.target.value)} className="w-full p-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-sm font-medium outline-none text-slate-900 dark:text-white" />
                       </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                       <div className="space-y-1.5">
                          ...
                          <input type="text" value={contact} onChange={e => setContact(e.target.value)} className="w-full p-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-sm font-medium outline-none text-slate-900 dark:text-white" />
                       </div>
                       <div className="space-y-1.5">
          ...
          {step === 2 && (
             <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 space-y-6">
                   <div className="space-y-3">
                      <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-1">Distrito</label>
                         ...
                         {DISTRITOS.map(d => (
                           <div 
                             ...
                             className={cn(
                                ...
                                district === d ? "bg-blue-50 border-blue-600 shadow-sm dark:bg-blue-900/30 dark:border-blue-500" : "bg-slate-50 dark:bg-slate-850 border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800"
                             )}
                           >
                              <div className={cn("w-4 h-4 rounded-full border flex items-center justify-center shrink-0", district === d ? "bg-blue-600 border-blue-600 dark:bg-blue-500 dark:border-blue-500" : "border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900")}>
                                 {district === d && <div className="w-1.5 h-1.5 bg-white rounded-full" />}
                              </div>
                              <span className={cn("font-bold text-xs tracking-tight", district === d ? "text-blue-900 dark:text-blue-200" : "text-slate-700 dark:text-slate-300")}>{d}</span>
                           </div>
                         ))}
                      </div>
                   </div>
             ...
             <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 space-y-4">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                         <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-1">Nacionalidade</label>
                         <select value={representantNacionalidade} onChange={e => setRepresentantNacionalidade(e.target.value)} className="w-full p-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-sm font-medium outline-none text-slate-800 dark:text-slate-100">
                ...
                {!isInformal && (
                  <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 space-y-4">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                           <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-1">Constituição</label>
                           <input type="text" value={constituicao} onChange={e => setConstituicao(e.target.value)} placeholder="Ex: Sociedade por Quotas" className="w-full p-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-sm font-medium outline-none text-slate-900 dark:text-white" />
                        </div>
                        <div className="space-y-1.5">
                           <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-1">Entidade Emissora da Licença</label>
                           <input type="text" value={emissoraLicenca} onChange={e => setEmissoraLicenca(e.target.value)} className="w-full p-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 text-sm font-medium outline-none text-slate-900 dark:text-white" />
                        </div>
                        <div className="space-y-1.5">
      ...
      <div className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 p-4 shrink-0 flex gap-4 sticky bottom-0">
         <button 
           onClick={nextStep}
           className="flex-1 py-4 bg-blue-600 text-white rounded-xl font-bold uppercase tracking-wide hover:bg-blue-700 dark:hover:bg-blue-500 transition-colors shadow-xl shadow-blue-200 dark:shadow-none flex items-center justify-center gap-2"
         >
           {step === 4 ? (
